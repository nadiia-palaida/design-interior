{
    ...
    const projects = document.querySelector('.our-projects__info')
    ...
    class ImageTrail {
        ...
        showNextImage() {
          ...
          /*  console.log('cacheMousePos.x', cacheMousePos.x)
            console.log('conatiner', container.offsetLeft)
            console.log('rect.top', content.scrollTop )*/
